...
${BLOUSE_TÍTULO}                        //img[@src='http://automationpractice.com/img/p/7/7-home_default.jpg']
...
${BOTÃO_REGISTER}                       //button[@type='submit'][contains(.,'Register')]
${BOTÃO_PROCEED_TO_CHECKOUT}            //button[@type='submit'][contains(.,'Proceed to checkout')]
...
Pesquisar Blouse
    ...
    Wait Until Element Is Visible    ${BLOUSE_TÍTULO}    
...
Criar Conta
    ...
    Click Element                    locator=${BOTÃO_REGISTER}
    Wait Until Element Is Visible    locator=${BOTÃO_PROCEED_TO_CHECKOUT}
    Click Element                    ${BOTÃO_PROCEED_TO_CHECKOUT}

Finalizar Compra
    Wait Until Element Is Visible    locator=uniform-cgv
    Click Element                    locator=uniform-cgv
    Click Element                    locator=${BOTÃO_PROCEED_TO_CHECKOUT} 
